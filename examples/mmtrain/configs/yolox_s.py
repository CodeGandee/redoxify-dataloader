...
custom_imports = dict(
    imports=['redoxify.plugin.mmdetection.runner'],
...
runner_type='redoxify.plugin.mmdetection.runner.RedoxMMRunner'
...
test_evaluator = dict(
    ann_file='/mnt/data/coco2017/annotations/instances_val2017.json',
    backend_args=None,
    metric='bbox',
    type='CocoMetric')
test_pipeline = [
...
train_cfg = dict(max_iters=500000, type='IterBasedTrainLoop', val_interval=2000)
