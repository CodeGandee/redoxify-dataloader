...
backend_args = None
checkpoint_hook = dict(
    by_epoch=False, interval=50, max_keep_ckpts=100, type='CheckpointHook')
data_root = '/mnt/data/coco2017/'
dataset_type = 'CocoDataset'
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False, interval=50, max_keep_ckpts=100,
        type='CheckpointHook'),
    logger=dict(interval=50, type='LoggerHook'),
    param_scheduler=dict(type='ParamSchedulerHook'),
    sampler_seed=dict(type='DistSamplerSeedHook'),
    timer=dict(type='IterTimerHook'),
    visualization=dict(draw=True, interval=100, type='DetVisualizationHook'))
...
model = dict(
    ...
    backbone=dict(
        ...
        embed_dims=192,
        init_cfg=dict(
            checkpoint='weights/swin_large_patch4_window12_384_22k.pth',
            type='Pretrained'),
        mlp_ratio=4,
        num_heads=[
            6,
...
pretrained = 'weights/swin_large_patch4_window12_384_22k.pth'
resume = False
...
work_dir = './work_dirs/ddq-detr-test'
