...
custom_imports = dict(
    imports=[
        "redoxify.plugin.mmdetection.runner.RedoxMMYoloRunner",
        "redoxify.plugin.mmdetection.datasets.person_dataset",
    ],
...
resume = False
backend_args = None
# load_from = "weights/yolov8_s_syncbn_fast_8xb16-500e_coco_20230117_180101-5aa5f0f1.pth"

# ========================Frequently modified parameters======================
# -----data related-----
data_root = '/mnt/data/crowdhuman/'  # Root path of data
# Path of train annotation file
train_ann_file = "annotations/crowdhuman_train.json"
train_data_prefix = 'images/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = "annotations/crowdhuman_val.json"
...
default_hooks = dict(
    ...
    visualization=dict(type='mmdet.DetVisualizationHook', draw=True, interval=50),
