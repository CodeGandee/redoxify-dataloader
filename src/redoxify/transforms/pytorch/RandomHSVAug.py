...
from redoxify.functionals.cuda_hsv import dali_hsv_image
...
class RandomHSVConfig:
    hue_delta : Union[float, DALINode] = field(default=0.15)
    saturation_delta : Union[float, DALINode] = field(default=0.7)
    value_delta : Union[float, DALINode] = field(default=0.4)
